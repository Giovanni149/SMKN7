            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <p>Hal ini seiring dengan penguasaan teknologi untuk dimanfaatkan sebaik mungkin,
                        ...
                        kami mengejewantahkan nilai-nilai pendidikan yang tertuang dalam visi misi adalah,
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="foot-logo">
                        ...
                        <p><?php echo date('Y'); ?> © copyright by <a href="https://www.instagram.com/adityadwiutamaa/" target="_blank">X</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
